...
import appPreviewImg from '../assets/app-nlw_copa_preview.png'
...
export default function Home(props: HomeProps) {
  ...
  // TODO: Add react-query com o next?
  ...
  async function createPool(event: FormEvent){
    ...
    try {
     ...
     alert('Bolão criado com sucesso, o código foi copiada para a área de transferência')
     setPoolTitle('')
    } catch (error) {
    ...
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center'> 
      ...
      <Image 
        ...
        <div className='mt-10 pt-10 border-t border-gray-600  flex items-center justify-between  text-gray-100'>
          <div className='flex first:items-center gap-6'>
          <Image 
           src={iconCheckImage} 
           alt=""
          />
...
// Dá um bizu na getStaticPoprs pois ela aguarda algum tipo de cache;
